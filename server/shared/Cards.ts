...
export function generateCards(quantities = defaultQuantities): readonly Card[] {
  ...
  function generateAllColorCards(
    colorCardQuantitiesMap: ColorCardQuantitiesMap
  ): readonly ColorCard[] {
  ...
  function generateColorCards(
    color: Color,
    quantities: ColorCardQuantities | undefined
  ): readonly ColorCard[] {
    return [
  ...
  function generateNumberCards(
    color: Color,
    valueQuantities: NumberCardValueQuantities
  ): readonly NumberCard[] {
